...
static Eina_Bool _play_finished(void *data (void), Eo *in, const Eo_Event_Description *desc EINA_UNUSED, void *event_info EINA_UNUSED)
{
   printf("<%s> <%d>\n", __func__, __LINE__);
   eo_del(in);
